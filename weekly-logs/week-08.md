...
- Related screenshots:
    ...
    <img src="../assets/create-DOB-tutorial-dapp-local-setup.png" alt="DOB Tutorial - Local Devnet Setup" width="100%">
    ...
    <img src="../assets/creating-a-digital-object-DOB-tutorial-dapp.png" alt="Creating a Digital Object - DOB Tutorial dApp" width="100%">
    <p style="text-align:center;">2. Creating a Digital Object (DOB)</p>
    </td>
    <td style="width:33.3%; vertical-align:top; text-align:center;">
    <img src="../assets/created-DOB-and-checked-spore-content-DOB-tutorial-dapp.png" alt="Created DOB and Checked Spore Content - DOB Tutorial" width="100%">
